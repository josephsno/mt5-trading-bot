...
def fetch_event_ticks(symbol, release_time, save_dir):
    ...
    # Same silent-partial-result risk as copy_rates_* -- if the terminal's
    # local tick history doesn't cover this window yet, this can come back
    # empty or short rather than erroring, so the row-count/range print
